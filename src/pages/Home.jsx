  ...
  return (
    <div className='lg:w-[82vw] mx-auto mb-10 px-2 '>
      <div className='grid grid-cols-1 lg:grid-cols-4 justify-items-center'>
        ...
        {loading ?
          <div className='flex justify-center items-center w-[80vw] h-[80vh] mx-auto'> <MoonLoader color="#6B7280" /></div>
          :
              ...
              <div key={product.id} className='lg:w-[18vw] w-full mt-10 shadow-2xl rounded-md bg-fixed py-4 overflow-hidden hover:shadow-purple-300 cursor-pointer '>
                ...
                <div className='px-4'>
                  ...
                  <div className='flex justify-between mt-4 '>
                    ...
                    <button onClick={() => addToCart(product)} className='px-6 py-[6px] rounded-md bg-gray-500 text-white ml-2 hover:bg-purple-500'>Add to Cart</button>
                  </div>
                </div>
              </div>
            )
